...
### CUB3D SRCS ###
SRCS 			= $(PARSER_SRCS) $(RAYC_SRCS) $(MENU_SRCS) cub3d.c exit_error.c init.c test.c utils.c game_start.c
SRC_DIR 		= src/
...
RAYC_SRCS		= draw.c movement.c move_utils.c mouse_rotate.c keyboard_rotate.c raycast.c texture.c texture_helper.c door.c button.c minimap.c
